...
import dev.pedrohb.algadelivery.delivery.tracking.api.model.CourierIdInput;
...
import dev.pedrohb.algadelivery.delivery.tracking.domain.service.DeliveryCheckpointService;
...
public class DeliveryController {
  ...
  public Delivery draft(@RequestBody @Valid DeliveryInput input) {
    return this.deliveryPreparationService.draft(input);
  }
